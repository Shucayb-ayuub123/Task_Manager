...
const Login = () => {
  ...
  const Validate = () => {
    ...
    if (!symbolRegex.test(Userinput.password)) {
      newError.password = "Password must contains at least one symbol (!@#$%^&*)"
      valid = false
    }
  ...
  return (
    <div className=" sm:h-30 md:h-52 lg:h-screen ">
      <div className="flex flex-col justify-center items-center my-auto mx-auto p-4 bg-white w-xs h-170   sm:w-md shadow-lg">
